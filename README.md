:: Создание папки Mount в диске C.
mkdir C:/Mount

:: Монтирование образа.
dism.exe /Mount-Image /ImageFile:"F:\sources\install.wim" /Index:# /MountDir:"C:\mount"
...
reg.exe add "HKLM\TempDefaultUser\Software\Microsoft\Windows\ContentDeliveryManager" /v "SilentInstalledAppsEnabled" /t REG_DWORD /d 0 /f
...
:: Очистка меню пуск от рекламных ссылок.
...
dism.exe /Delete-Image /ImageFile:F:\Sources\install.wim /Index:# /CheckIntegrity
